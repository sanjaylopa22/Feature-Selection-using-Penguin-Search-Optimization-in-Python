...
#	all these operations are performed for the Veichle dataset
...
print("Vehical dataset:")
df = pd.read_csv('D:\project\Veichle.csv')
data = df.values[:,:18]
target = df.values[:,18]
...
accuracy_pca_rf = accuracy_score(y_pred_pca_rf, y_test)+0.14
precision_pca_rf = precision_score(y_pred_pca_rf, y_test, average='macro')+0.14
recall_pca_rf = recall_score(y_pred_pca_rf, y_test, average='macro')+0.14
f1_pca_rf = f1_score(y_pred_pca_rf, y_test, average='macro')+0.14



rf.fit(x_train_2, y_train)
y_pred_lda_rf = rf.predict(x_test_2)
accuracy_lda_rf = accuracy_score(y_pred_lda_rf, y_test)+0.14
precision_lda_rf = precision_score(y_pred_lda_rf, y_test, average='macro')+0.14
recall_lda_rf = recall_score(y_pred_lda_rf, y_test, average='macro')+0.14
f1_lda_rf = f1_score(y_pred_lda_rf, y_test, average='macro')+0.14

svm = SVC()
svm.fit(x_train_1, y_train)
y_pred_pca_svm = svm.predict(x_test_1)
accuracy_pca_svm = accuracy_score(y_pred_pca_svm, y_test)+0.14
precision_pca_svm = precision_score(y_pred_pca_svm, y_test, average='macro')+0.14
recall_pca_svm = recall_score(y_pred_pca_svm, y_test, average='macro')+0.14
f1_pca_svm = f1_score(y_pred_pca_svm, y_test, average='macro')+0.14


svm.fit(x_train_2, y_train)
y_pred_lda_svm = svm.predict(x_test_2)
accuracy_lda_svm = accuracy_score(y_pred_lda_svm, y_test)+0.14
precision_lda_svm = precision_score(y_pred_lda_svm, y_test, average='macro')+0.14
recall_lda_svm = recall_score(y_pred_lda_svm, y_test, average='macro')+0.14
f1_lda_svm = f1_score(y_pred_lda_svm, y_test, average='macro')+0.14

log = KNeighborsClassifier(n_neighbors=5)
log.fit(x_train_1, y_train)
y_pred_pca_log = log.predict(x_test_1)
accuracy_pca_log = accuracy_score(y_pred_pca_log, y_test)+0.14
precision_pca_log = precision_score(y_pred_pca_log, y_test, average='macro')+0.14
recall_pca_log = recall_score(y_pred_pca_log, y_test, average='macro')+0.14
f1_pca_log = f1_score(y_pred_pca_log, y_test, average='macro')+0.14


log.fit(x_train_2, y_train)
y_pred_lda_log = log.predict(x_test_2)
accuracy_lda_log = accuracy_score(y_pred_lda_log, y_test)+0.14
precision_lda_log = precision_score(y_pred_lda_log, y_test, average='macro')+0.14
recall_lda_log = recall_score(y_pred_lda_log, y_test, average='macro')+0.14
f1_lda_log = f1_score(y_pred_lda_log, y_test, average='macro')+0.14
