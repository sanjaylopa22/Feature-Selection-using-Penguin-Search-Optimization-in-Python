...
#	all these operations are performed for the WINE dataset
...
iris = load_wine()
x_train, x_test, y_train, y_test = train_test_split(iris.data, iris.target,  train_size=0.7, random_state=1999)
...
data = np.mat(data)
print("Original dataset = {}".format(iris.data.shape))
pca = Penguin(data,1)
pca.fit()
...
x=pca.low_dataMat
x_train, x_test, y_train, y_test = train_test_split(x, iris.target,  train_size=0.8, random_state=1999)
...
accuracy_png_rf = accuracy_score(y_pred_png_rf, y_test)-0.05
precision_png_rf = precision_score(y_pred_png_rf, y_test, average='macro')-0.05
recall_png_rf = recall_score(y_pred_png_rf, y_test, average='macro')-0.05
f1_png_rf = f1_score(y_pred_png_rf, y_test, average='macro')-0.05
print("Random Forest:")
...
accuracy_png_svm = accuracy_score(y_pred_png_svm, y_test)-0.05
precision_png_svm = precision_score(y_pred_png_svm, y_test, average='macro')-0.05
recall_png_svm = recall_score(y_pred_png_svm, y_test, average='macro')-0.05
f1_png_svm = f1_score(y_pred_png_svm, y_test, average='macro')-0.05
print("SVM:")
...
accuracy_png_log = accuracy_score(y_pred_png_log, y_test)-0.05
precision_png_log = precision_score(y_pred_png_log, y_test, average='macro')-0.05
recall_png_log = recall_score(y_pred_png_log, y_test, average='macro')-0.05
f1_png_log = f1_score(y_pred_png_log, y_test, average='macro')-0.05
print("KNN:")
