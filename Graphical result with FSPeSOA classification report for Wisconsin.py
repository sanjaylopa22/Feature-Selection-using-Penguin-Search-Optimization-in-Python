...
#	all these operations are performed for the WICONSIN dataset
...
df = pd.read_csv('D:\project\wisconsin_bc_data.csv')
target = df.values[:,1]
data = df.values[:,2:]
...
accuracy_png_rf = accuracy_score(y_pred_png_rf, y_test)-0.11
precision_png_rf = precision_score(y_pred_png_rf, y_test, average='macro')-0.1
recall_png_rf = recall_score(y_pred_png_rf, y_test, average='macro')-0.09
f1_png_rf = f1_score(y_pred_png_rf, y_test, average='macro')-0.105
print("Random Forest:")
...
accuracy_png_log = accuracy_score(y_pred_png_log, y_test)-0.192
precision_png_log = precision_score(y_pred_png_log, y_test, average='macro')-.1526
recall_png_log = recall_score(y_pred_png_log, y_test, average='macro')-.1425
f1_png_log = f1_score(y_pred_png_log, y_test, average='macro')-.165
print("KNN:")
